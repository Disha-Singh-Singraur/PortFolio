...
const projectSparkles = [
  { top: "12%", left: "6%", size: 24, color: "text-cyan-400", delay: "0s", duration: "5s" },
  { top: "32%", left: "93%", size: 30, color: "text-yellow-400", delay: "1.5s", duration: "7.5s" },
  { top: "58%", left: "8%", size: 20, color: "text-pink-400", delay: "0.5s", duration: "6s" },
  { top: "82%", left: "91%", size: 28, color: "text-purple-400", delay: "2.2s", duration: "8.2s" },
  { top: "45%", left: "95%", size: 18, color: "text-emerald-400", delay: "1.1s", duration: "6.8s" },
  { top: "72%", left: "5%", size: 22, color: "text-amber-400", delay: "2.7s", duration: "5.8s" },
  { top: "15%", left: "22%", size: 16, color: "text-yellow-300", delay: "0.3s", duration: "5.5s" },
  { top: "48%", left: "38%", size: 22, color: "text-purple-300", delay: "2.5s", duration: "7.2s" },
  { top: "65%", left: "62%", size: 18, color: "text-cyan-300", delay: "1.0s", duration: "6.0s" },
  { top: "85%", left: "28%", size: 24, color: "text-emerald-300", delay: "3.1s", duration: "7.8s" },
  { top: "90%", left: "50%", size: 20, color: "text-pink-400", delay: "0.7s", duration: "6.5s" },
  { top: "18%", left: "80%", size: 26, color: "text-yellow-400", delay: "2.0s", duration: "6.8s" },
  { top: "78%", left: "75%", size: 18, color: "text-purple-400", delay: "1.4s", duration: "5.2s" },
];
